    ...
    fetch('https://forge.speedtest.cn/api/location/info')
        ...
        .then(res => {
            ...
            // if (ip_content != null && typeof (result.ip) != undefined) {
                ...
                ip_content.innerHTML = '欢迎来自: <span class="p ipred">' + res.province + res.city + res.distinct +res.isp + "</span> 的小伙伴<br>" + "访问IP为： <span class='p cyan'>" + res.ip + "</span><br>浏览器版本：<span class='p blue'>" + getBrowserInfo() + '</span>';
            // }
